...
_G.packer_plugins = {
  ...
  ["trouble.nvim"] = {
    config = { "\27LJ\2\nù\1\0\0\3\0\4\0\a6\0\0\0'\2\1\0B\0\2\0029\0\2\0005\2\3\0B\0\2\1K\0\1\0\1\0\6\14auto_fold\1\25use_diagnostic_signs\2\15auto_close\2\14auto_open\1\tmode\25document_diagnostics\rposition\nright\nsetup\ftrouble\frequire\0" },
    loaded = true,
...
vim.cmd [[au FileType ruby ++once lua require("packer.load")({'vim-i18n', 'vim-rails', 'vim-ruby', 'ri.vim', 'smartgf.vim', 'vim-rubyhash'}, { ft = "ruby" }, _G.packer_plugins)]]
